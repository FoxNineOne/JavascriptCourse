...
},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"3QBkH","./config.js":"2hPh4","./views/recipeView.js":"3wx5k","./views/searchView.js":"kbE4Z","./views/resultsView.js":"kBQ4r","./views/paginationView.js":"7NIiB","./views/bookmarksView.js":"1qGeA","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const loadRecipe = async function(id) {
    try {
        ...
        console.error(`\u{203C}\u{FE0F}${err}\u{203C}\u{FE0F}`);
        throw err;
    }
};
...
},{"regenerator-runtime":"f6ot0","./config":"2hPh4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        const prevPage = `<button data-goto="${curPage - 1}" class="btn--inline pagination__btn--prev">
            <svg class="search__icon">
          ...
          `;
        const nextPage = `<button data-goto="${curPage + 1}" class="btn--inline pagination__btn--next">
            <span>Page ${curPage + 1}</span>
            <svg class="search__icon">
              <use href="${(0, _iconsSvgDefault.default)}#icon-arrow-right"></use>
            </svg>
        ...
        // Other page
        if (curPage < numPages) return `${prevPage}
        ${nextPage}`;
        return ``;
    }
}
...
class BookmarksView extends (0, _viewJsDefault.default) {
    ...
    _errorMessage = `No bookmarks yet. Find a nice recipe and bookmark it \u{1F516}`;
    _message = '';
    addHandlerRender(handler) {
...
},{"./View.js":"jSw21","./previewView.js":"6tKHS","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5DuvQ","7dWZ8"], "7dWZ8", "parcelRequire3a11", {}, "./", "/")
