...
})(
  {
    gQqV7: [
      function (require, module, exports, __globalThis) {
        ...
        module.bundle.HMR_BUNDLE_ID = 'c91fb734d53f6346';
        ('use strict');
...
*/ var _cloneDeepJs = require('../node_modules/lodash-es/cloneDeep.js');
      ...
      {
        './shoppingCart.js': 'jy40L',
        '../node_modules/lodash-es/cloneDeep.js': 'aEA71',
    ...
    buRg9: [
      ...
      },
      {
        './_Stack.js': '6wG1y',
        './_arrayEach.js': '4Khli',
        './_assignValue.js': '8RUky',
        './_baseAssign.js': '36b2A',
        './_baseAssignIn.js': '6X6I8',
        './_cloneBuffer.js': 'gYki8',
        './_copyArray.js': 'gitUH',
        './_copySymbols.js': 'KCDli',
        './_copySymbolsIn.js': 'hpWSw',
        './_getAllKeys.js': '9tKZj',
        './_getAllKeysIn.js': 'hrnQs',
        './_getTag.js': 'W4F3M',
        './_initCloneArray.js': '17G5G',
        './_initCloneByTag.js': 'fzQ2c',
        './_initCloneObject.js': '1zGQG',
        './isArray.js': 'lwFnW',
        './isBuffer.js': '7iJWZ',
        './isMap.js': 'iFNkS',
        './isObject.js': '73cZB',
    ...
    '6wG1y': [
      ...
      {
        './_ListCache.js': '7lAKH',
        './_stackClear.js': 'k7IBG',
        './_stackDelete.js': '4bWzp',
        './_stackGet.js': '1uf1j',
        './_stackHas.js': '3yD3b',
        './_stackSet.js': 'lvNyE',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'jnFvT',
    ...
    '7lAKH': [
      ...
      {
        './_listCacheClear.js': 'kgPNk',
        './_listCacheDelete.js': 'ibJ9h',
        './_listCacheGet.js': 'bJjQE',
        './_listCacheHas.js': 'i7OGI',
        './_listCacheSet.js': '3Pegv',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'jnFvT',
      },
    ],
    kgPNk: [
    ...
    '7SXI0': [
      ...
      {
        './_mapCacheClear.js': 'amfXS',
        './_mapCacheDelete.js': 'ekQlK',
        './_mapCacheGet.js': 'dYrro',
        './_mapCacheHas.js': 'dn2zR',
        './_mapCacheSet.js': 'k0Pmc',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'jnFvT',
      },
    ],
    amfXS: [
    ...
    lp6r3: [
      ...
      {
        './_arrayLikeKeys.js': 'k4mZa',
        './_baseKeys.js': 'eRRPJ',
        './isArrayLike.js': 'f6ar1',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'jnFvT',
      },
    ],
    k4mZa: [
      ...
      {
        './_baseTimes.js': 'gAbnY',
        './isArguments.js': '3btgs',
        './isArray.js': 'lwFnW',
        './isBuffer.js': '7iJWZ',
        './_isIndex.js': 'dIxrx',
        './isTypedArray.js': '9GW4z',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'jnFvT',
      },
    ],
    gAbnY: [
    ...
    '3btgs': [
      ...
      {
        './_baseIsArguments.js': '8nljL',
        './isObjectLike.js': 'ilzbi',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'jnFvT',
      },
    ],
    '8nljL': [
    ...
    eRRPJ: [
      ...
      {
        './_isPrototype.js': '8bdyt',
        './_nativeKeys.js': '8gDuO',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'jnFvT',
      },
    ],
    '8bdyt': [
    ...
    fzQ2c: [
      ...
      {
        './_cloneArrayBuffer.js': 'CsDnD',
        './_cloneDataView.js': 'f0QLp',
        './_cloneRegExp.js': 'cnZQl',
        './_cloneSymbol.js': 'XuHjz',
        './_cloneTypedArray.js': 'a82Gn',
        '@parcel/transformer-js/src/esmodule-helpers.js': 'jnFvT',
      },
    ],
    CsDnD: [
...
//# sourceMappingURL=starter.d53f6346.js.map
